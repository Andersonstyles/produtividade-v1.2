    ...
    <form action="#" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="registration" name="registration" placeholder="Informe a matrícula"
                    class="form-control <?= $errors['registration'] ? 'is-invalid' : '' ?>"
                    value="<?= $registration ?>">
                <div class="invalid-feedback">
                    <?= $errors['registration'] ?>
                </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" id="office" name="office" placeholder="Informe o cargo"
                    class="form-control <?= $errors['office'] ? 'is-invalid' : '' ?>"
                    value="<?= $office ?>">
                <div class="invalid-feedback">
                    <?= $errors['office'] ?>
                </div>
